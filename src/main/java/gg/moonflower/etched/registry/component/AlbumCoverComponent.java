...
public class AlbumCoverComponent implements TooltipProvider {
    ...
    public boolean equals(Object object) {
        return object instanceof AlbumCoverComponent component && ItemStack.listMatches(this.items, component.items) && ItemStack.matches(this.coverStack, component.coverStack);
    }
    ...
    public void addToTooltip(Item.TooltipContext context, Consumer<Component> tooltipAdder, TooltipFlag tooltipFlag) {
        for (ItemStack record : this.items) {
            if (!record.isEmpty()) {
                JukeboxPlayable jukeboxPlayable = record.get(DataComponents.JUKEBOX_PLAYABLE);
